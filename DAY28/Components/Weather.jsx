      ...
      <div className="row">
        ...
        <div className="col-3 right-side-infos ">
          <div className="p-1 side-info">
            <span>
              <img
                src="../assets/icons/icons8-dew-point-100.png"
                alt="icon"
                className="icon"
              />
              Humiditiy:
          ...
          <div className=" p-1 side-info">
            <span>
              <img
                src="../assets/icons/icons8-air-100.png"
                alt="icon"
                className="icon"
              />
              Air Pressure:
          ...
          <div className=" p-1 side-info">
            <span>
              <img
                src="../assets/icons/icons8-heavy-rain-100.png"
                alt="icon"
                className="icon"
              />
              Chance of Rain:
          ...
          <div className="p-1 side-info">
            <span>
              <img
                src="../assets/icons/icons8-night-wind-100.png"
                alt="icon"
                className="icon"
              />
              Wind Speed:
